const Modal = ({children, showModal, onClose, modalType}:any) => {
  return (
    <div
      className={`${showModal ? "pointer-events-auto scale-100 opacity-100" : "pointer-events-none scale-90 opacity-0"} fixed top-[50%] left-[50%] z-99  translate-[-50%] shadow shadow-black rounded-lg overflow-hidden bg-white transition-normal duration-300`}
    >
